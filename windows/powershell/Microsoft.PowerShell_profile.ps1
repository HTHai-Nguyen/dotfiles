...
function ll { eza -l -o --icons --color=auto --color-scale=size --total-size --group-directories-last  $args }
...
function uninstall { scoop uninstall $args }
function update { scoop update $args }

# Aliases config quickly
function glzconf {vi ~/.glzr/glazewm/config.yaml} 
